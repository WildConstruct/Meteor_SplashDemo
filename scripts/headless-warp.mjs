...
warp.blend = 0.5;
s.warp = warp;
// upright plane (normal lying toward the horizon, low wn.y) + drive drips from
// that tilt (no manual amount) so the verticality path actually activates
s.worldNormal = { x: 0, y: 0.2, z: 0.98 };
